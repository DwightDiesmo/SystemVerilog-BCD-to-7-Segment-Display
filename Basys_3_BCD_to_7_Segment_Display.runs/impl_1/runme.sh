...
HD_PWD='C:/Users/dwigh/Xilinx/Basys_3_BCD_to_7_Segment_Display/Basys_3_BCD_to_7_Segment_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_to_7_Segment_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_to_7_Segment_Display.tcl -notrace
