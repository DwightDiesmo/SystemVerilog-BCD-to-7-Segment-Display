...
HD_PWD='C:/Users/dwigh/Xilinx/Basys_3_BCD_to_7_Segment_Display/Basys_3_BCD_to_7_Segment_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_to_7_Segment_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_to_7_Segment_Display.tcl
